...
import 'package:qaz_mebel/constants/constants.dart';
...
import 'package:qaz_mebel/models/user_model/user_model.dart';
...
class FirebaseFirestoreHelper {
  ...
  Future<List<ProductModel>> getBestProducts() async {
    try {
      QuerySnapshot<Map<String, dynamic>> querySnapshot =
      await _firebaseFirestore.collectionGroup("products")
          .get();

      List<ProductModel> productModelList = [];
      for (var documentSnapshot in querySnapshot.docs) {
        var documentData = documentSnapshot.data();
        if (documentData != null && documentData["isFavourite"] == true) {
          productModelList.add(ProductModel.fromJson(documentData));
        }
      }
      return productModelList;
    } catch (e) {
  ...
  Future<List<ProductModel>> getSaleProducts() async {
    try {
      ...
      for (var documentSnapshot in querySnapshot.docs) {
        var documentData = documentSnapshot.data();
        if (documentData != null && documentData["isSale"] == true) {
          productModelList.add(ProductModel.fromJson(documentData));
        }
      }
      return productModelList;
